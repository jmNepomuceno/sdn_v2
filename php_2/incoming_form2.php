...
<body>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button>Print</button>
                    <button id="close-pending-modal">Close</button>
                ...
                <div  class="modal-body-incoming">
                    ...
                    <div id='approval-form'>
                        ...
                        <div id="approval-form-btns">
                            <button id="pending-approved-btn" data-bs-toggle="modal" data-bs-target="#myModal-incoming"> Interdepartamental Referral </button>
                            <button id="interdept-btn" data-bs-toggle="modal" data-bs-target="#myModal-incoming"> Immediate Approval </button>
                        </div>
                    </div>
                    ...
                    <div class="interdept-div">
                        ...
                        <div class="int-dept-btn-div">
                            <button id="int-dept-btn">Send / Forward</button>
                        </div>
                    </div>
    ...
    <script src="../js_2/incoming_form.js?v= <?php echo time(); ?>"></script>
