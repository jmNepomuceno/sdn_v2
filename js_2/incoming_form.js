$(document).ready(function(){
    ...
    const ajax_method = (index, event) => {
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                // print mo kada isang response value sa process_pending.php, hanapin mo kung sino yung may mali. gl gl glhf tomorrow :))))))))))
    ...
    $(document).on('click' , '.accordion-btn' , function(event){
        // var element = document.querySelector('.tr-incoming');
